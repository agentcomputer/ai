...
"[project]/src/lib/mcp-manager.ts [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mcp$2d$manager$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/mcp-manager.ts [app-ssr] (ecmascript)");
...
;
;
const useMCP = (serverConfigs = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$mcp$2d$servers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MCP_SERVER_CONFIGS"])=>{
    const [mcpManagerInstance, setMcpManagerInstance] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [connectedServers, setConnectedServers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]);
    const initializeMCP = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async ()=>{
        setIsConnecting(true);
        setError(null);
        setTools([]);
        setConnectedServers([]);
        const manager = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mcp$2d$manager$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMcpManager"])(); // Use the singleton instance
        try {
            const autoConnectPromises = Object.entries(serverConfigs).filter(([_, config])=>config.autoConnect).map(async ([serverId, config])=>{
                try {
            ...
            const successfulConnections = (await Promise.all(autoConnectPromises)).filter((id)=>id !== null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        return ()=>{
            ...
            const manager = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mcp$2d$manager$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMcpManager"])();
            manager.disconnectAll().catch((e)=>console.error("Error during MCP disconnectAll:", e));
        };
    }, [
        initializeMCP
    ]); // Re-run if serverConfigs changes, though typically it won't
    const executeTool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (serverId, toolName, args)=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$mcp$2d$servers$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/config/mcp-servers.ts [app-ssr] (ecmascript)"); // Ensure this path is correct
"use client";
;
;
;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7961b58c._.js.map