(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_79184215._.js", {
...
"[project]/src/lib/mcp-manager.ts [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mcp$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/mcp-manager.ts [app-client] (ecmascript)");
...
;
;
const useMCP = (serverConfigs = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$config$2f$mcp$2d$servers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MCP_SERVER_CONFIGS"])=>{
    _s();
    const [mcpManagerInstance, setMcpManagerInstance] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const initializeMCP = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMCP.useCallback[initializeMCP]": async ()=>{
            setIsConnecting(true);
            setError(null);
            setTools([]);
            setConnectedServers([]);
            const manager = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mcp$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMcpManager"])(); // Use the singleton instance
            try {
                const autoConnectPromises = Object.entries(serverConfigs).filter({
                    "useMCP.useCallback[initializeMCP].autoConnectPromises": ([_, config])=>config.autoConnect
                }["useMCP.useCallback[initializeMCP].autoConnectPromises"]).map({
                    "useMCP.useCallback[initializeMCP].autoConnectPromises": async ([serverId, config])=>{
                        try {
                ...
                }["useMCP.useCallback[initializeMCP].autoConnectPromises"]);
                const successfulConnections = (await Promise.all(autoConnectPromises)).filter({
                    "useMCP.useCallback[initializeMCP].successfulConnections": (id)=>id !== null
                }["useMCP.useCallback[initializeMCP].successfulConnections"]);
                setConnectedServers(successfulConnections);
                if (successfulConnections.length > 0) {
                    const availableTools = await manager.listAvailableTools();
                    setTools(availableTools);
                } else if (Object.values(serverConfigs).some({
                    "useMCP.useCallback[initializeMCP]": (c)=>c.autoConnect
                }["useMCP.useCallback[initializeMCP]"])) {
        ...
        "useMCP.useEffect": ()=>{
            ...
            return ({
                "useMCP.useEffect": ()=>{
                    ...
                    const manager = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mcp$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMcpManager"])();
                    manager.disconnectAll().catch({
                        "useMCP.useEffect": (e)=>console.error("Error during MCP disconnectAll:", e)
                    }["useMCP.useEffect"]);
                }
            })["useMCP.useEffect"];
        }
    ...
    const executeTool = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useMCP.useCallback[executeTool]": async (serverId, toolName, args)=>{
    ...
    }["useMCP.useCallback[executeTool]"], [
        mcpManagerInstance,
        connectedServers
    ]);
    return {
...
_s(useMCP, "yKxtzBYBhFCxBIZcTG6fZLO1/I4=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_79184215._.js.map