...
export const ALL_TOOLS: Tool[] = [
  ...
  },
  {
    ...
    name: 'Comms Hub',
    icon: MessageSquare,
    description: 'Integrated email, calendar, and messenger. (Placeholder UI) Agent could help draft emails, schedule meetings, or summarize message threads.',
    component: CommsHub,
  ...
  },
  {
    ...
    name: 'Creative Suite',
    icon: ImageIcon,
    description: 'Tools for image generation and editing. (Placeholder UI) Agent could generate images from text prompts or suggest edits.',
  ...
  },
  {
    ...
    name: 'Task Manager',
    icon: ListChecks,
    description: 'AI-assisted task planning and tracking. (Placeholder UI) Agent can help break down tasks, set reminders, or suggest task prioritization.',
  ...
  },
  {
    ...
    icon: Table,
    description: 'Data organization, calculation, and visualization. (Placeholder UI) Agent could help with formula generation, data analysis, or chart creation.',
  ...
  },
  {
    ...
    icon: Presentation,
    description: 'Create slideshows with AI assistance. (Placeholder UI) Agent can help draft slide content, suggest layouts, or generate speaker notes.',
  ...
  },
  {
    ...
    name: 'Code Editor',
    icon: Code,
    description: 'View and make minor edits to code snippets. (Placeholder UI) Agent could explain code snippets, suggest simple refactors, or help debug.',
  ...
  },
  {
    ...
    name: 'Game Center',
    icon: Gamepad2,
    description: 'Access to casual games. (Placeholder UI) Agent could provide game tips, explain rules, or track high scores.',
  ...
  },
  {
    ...
    name: 'Settings',
    icon: SettingsIcon,
    description: 'Customize your Agent-Computer experience. (Placeholder UI) Agent could help find specific settings or explain configuration options.',
